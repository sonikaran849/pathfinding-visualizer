...
export default class PathFindingVisualizer extends Component {
    ...
    visualizeDijkstra() {
        ...
        // Mark nodes in shortest path for clearing
        // nodesInShortestPathOrder.forEach(node => {
        //     grid[node.row][node.col].isShortestPath = true;
        // });
        ...
        return(
            <>
                <div className='header'>
                    ...
                    <button className='btn-clear' onClick={() => this.clearBoard()} >Clear Board</button>
                    <div className='col'>
                        ...
                        {row.map((node, nodeIdx) => {
                            ...
                            return (
                                <Node
                                    ...
                                    onMouseHover={(row,col) => this.handleMouseHover(row,col)}
